...
public interface PossessoDAO {
    ...
    public boolean insertPossessoLDB(String isbn, String nt, int quantita, String fruizione);   //se non esiste già, inserisce un nuovo possesso del libro con ISBN 'isbn' nel DB e ritorna "true", altrimenti ritorna "false"
    public boolean insertPossessoFDB(int numero, String issn, String nt, int quantita, String fruizione);   //se non esiste già, inserisce un nuovo possesso del fascicolo numero 'numero' della rivista con ISSN 'issn' nel DB e ritorna "true", altrimenti ritorna "false"

...
public class HomePage {
    ...
    public HomePage(JFrame frameC, Controller controller) {
        ...
        for (int i = 0; i < controller.listaLibri.size(); i++) {    //scorre l'ArrayList di tutti i libri
            if (!distinctGenereList.contains(controller.listaLibri.get(i).getGenere()))    //controlla se 'distinctGenereList' non contiene il genere dell'i-esimo libro di 'controller.listaLibri'
        ...
        if (controller.libriTitoloPreferiti != null && controller.possessolPreferiti != null && controller.librerieLibriPreferiti != null) {    //controlla se 'controller.libriTitoloPreferiti', 'controller.possessolPreferiti' e 'controller.librerieLibriPreferiti' non sono a null
             for (int i = 0; i < controller.libriTitoloPreferiti.size(); i++) {  //scorre la lista dei libri preferiti dell'utente
                if (controller.possessolPreferiti.get(i).getFruizione().equals("Digitale") || controller.possessolPreferiti.get(i).getFruizione().equals("AudioLibro")) { //controlla se l'i-esimo libro è disponibile in modalità digitale o audiolibro
                    model.addRow(new Object[]{controller.libriTitoloPreferiti.get(i), "∞", controller.possessolPreferiti.get(i).getFruizione(), controller.librerieLibriPreferiti.get(i).getNome(), controller.librerieLibriPreferiti.get(i).getIndirizzo(), controller.librerieLibriPreferiti.get(i).getNumeroTelefonico(), controller.librerieLibriPreferiti.get(i).getSitoWeb()});    //aggiunge una nuova riga nella tabella
                } else if (controller.possessolPreferiti.get(i).getFruizione().equals("Cartaceo") && controller.possessolPreferiti.get(i).getQuantita() == 0) {   //controlla se l'i-esimo libro non è disponibile
                    model.addRow(new Object[]{controller.libriTitoloPreferiti.get(i), "Non Diponibile", controller.possessolPreferiti.get(i).getFruizione(), controller.librerieLibriPreferiti.get(i).getNome(), controller.librerieLibriPreferiti.get(i).getIndirizzo(), controller.librerieLibriPreferiti.get(i).getNumeroTelefonico(), controller.librerieLibriPreferiti.get(i).getSitoWeb()});   //aggiunge una nuova riga nella tabella
                } else {
                    model.addRow(new Object[]{controller.libriTitoloPreferiti.get(i), controller.possessolPreferiti.get(i).getQuantita(), controller.possessolPreferiti.get(i).getFruizione(), controller.librerieLibriPreferiti.get(i).getNome(), controller.librerieLibriPreferiti.get(i).getIndirizzo(), controller.librerieLibriPreferiti.get(i).getNumeroTelefonico(), controller.librerieLibriPreferiti.get(i).getSitoWeb()});  //aggiunge una nuova riga nella tabella
                }
            }
        }
        ...
        if (controller.serieTitoloPreferiti != null && controller.possessosPreferiti != null && controller.librerieSeriePreferiti != null) {    //controlla se 'controller.serieTitoloPreferiti', 'controller.possessosPreferiti' e 'controller.librerieSeriePreferiti' non sono a null
            for (int i = 0; i < controller.serieTitoloPreferiti.size(); i++) {  //scorre la lista delle serie preferite dell'utente
                if(controller.possessosPreferiti.get(i).getFruizione().equals("Digitale") || controller.possessosPreferiti.get(i).getFruizione().equals("AudioLibro")) {  //controlla se l'i-esima serie è disponibile in modalità digitale o audiolibro
                    model.addRow(new Object[]{controller.serieTitoloPreferiti.get(i), "∞", controller.possessosPreferiti.get(i).getFruizione(), controller.librerieSeriePreferiti.get(i).getNome(), controller.librerieSeriePreferiti.get(i).getIndirizzo(), controller.librerieSeriePreferiti.get(i).getNumeroTelefonico(), controller.librerieSeriePreferiti.get(i).getSitoWeb()});   //aggiunge una nuova riga nella tabella
                }else if(controller.possessosPreferiti.get(i).getFruizione().equals("Cartaceo") && controller.possessosPreferiti.get(i).getQuantita() == 0) { //controlla se l'i-esima serie non è disponibile
        ...
        if (controller.fascicoliTitoloPreferiti != null && controller.possessofPreferiti != null && controller.librerieFascicoliPreferiti != null) {    //controlla se 'controller.fascicoliTitoloPreferiti', 'controller.possessofPreferiti' e 'controller.librerieFascicoliPreferiti' non sono a null
            for (int i = 0; i < controller.fascicoliTitoloPreferiti.size(); i++) {  //scorre la lista dei fascicoli preferiti dallutente
                if(controller.possessofPreferiti.get(i).getFruizione().equals("Digitale") || controller.possessofPreferiti.get(i).getFruizione().equals("AudioLibro")) {  //controlla se l'i-esimo fascicolo è disponibile in modalità digitale o audiolibro
                    model.addRow(new Object[]{controller.fascicoliTitoloPreferiti.get(i), "∞", controller.possessofPreferiti.get(i).getFruizione(), controller.librerieFascicoliPreferiti.get(i).getNome(), controller.librerieFascicoliPreferiti.get(i).getIndirizzo(), controller.librerieFascicoliPreferiti.get(i).getNumeroTelefonico(), controller.librerieFascicoliPreferiti.get(i).getSitoWeb()});    //aggiunge una nuova riga nella tabella
                } else if(controller.possessofPreferiti.get(i).getFruizione().equals("Cartaceo") && controller.possessofPreferiti.get(i).getQuantita() == 0) {    //controlla se l'i-esimo fascicolo non è disponibile
                    ...
                    if (controller.fascicoliTitoloPreferiti != null && controller.possessofPreferiti != null && controller.librerieFascicoliPreferiti != null) {    //controlla se 'controller.fascicoliTitoloPreferiti', 'controller.possessofPreferiti' e 'controller.librerieFascicoliPreferiti' non sono a null
                        for (int i = 0; i < controller.fascicoliTitoloPreferiti.size(); i++) {  //scorre la lista dei fascicoli preferiti dallutente
                            if(controller.possessofPreferiti.get(i).getFruizione().equals("Digitale") || controller.possessofPreferiti.get(i).getFruizione().equals("AudioLibro")) {  //controlla se l'i-esimo fascicolo è disponibile in modalità digitale o audiolibro
                                ...
                                model.addRow(new Object[]{controller.fascicoliTitoloPreferiti.get(i), "Non Diponibile" , controller.possessofPreferiti.get(i).getFruizione(), controller.librerieFascicoliPreferiti.get(i).getNome(), controller.librerieFascicoliPreferiti.get(i).getIndirizzo(), controller.librerieFascicoliPreferiti.get(i).getNumeroTelefonico(), controller.librerieFascicoliPreferiti.get(i).getNome()});   //aggiunge una nuova riga nella tabella
                            } else {
                                model.addRow(new Object[]{controller.fascicoliTitoloPreferiti.get(i), controller.possessofPreferiti.get(i).getQuantita(), controller.possessofPreferiti.get(i).getFruizione(), controller.librerieFascicoliPreferiti.get(i).getNome(), controller.librerieFascicoliPreferiti.get(i).getIndirizzo(), controller.librerieFascicoliPreferiti.get(i).getNumeroTelefonico(), controller.librerieFascicoliPreferiti.get(i).getSitoWeb()});  //aggiunge una nuova riga nella tabella
                            }
                        }
            ...
            public void itemStateChanged(ItemEvent e) {
                ...
                if (controller.serieTitoloPreferiti != null && controller.possessosPreferiti != null && controller.librerieSeriePreferiti != null) {    //controlla se 'controller.serieTitoloPreferiti', 'controller.possessosPreferiti' e 'controller.librerieSeriePreferiti' non sono a null
                    for (int i = 0; i < controller.serieTitoloPreferiti.size(); i++) {  //scorre la lista delle serie preferite dell'utente
                        if(controller.possessosPreferiti.get(i).getFruizione().equals("Digitale") || controller.possessosPreferiti.get(i).getFruizione().equals("AudioLibro")) {  //controlla se l'i-esima serie è disponibile in modalità digitale o audiolibro
                            model.addRow(new Object[]{controller.serieTitoloPreferiti.get(i), "∞", controller.possessosPreferiti.get(i).getFruizione(), controller.librerieSeriePreferiti.get(i).getNome(), controller.librerieSeriePreferiti.get(i).getIndirizzo(), controller.librerieSeriePreferiti.get(i).getNumeroTelefonico(), controller.librerieSeriePreferiti.get(i).getSitoWeb()}); //aggiunge una nuova riga nella tabella
                        } else if(controller.possessosPreferiti.get(i).getFruizione().equals("Cartaceo") && controller.possessosPreferiti.get(i).getQuantita() == 0){ //controlla se l'i-esimo fascicolo non è disponibile
                            model.addRow(new Object[]{controller.serieTitoloPreferiti.get(i), "Non Diponibile" , controller.possessosPreferiti.get(i).getFruizione(), controller.librerieSeriePreferiti.get(i).getNome(), controller.librerieSeriePreferiti.get(i).getIndirizzo(), controller.librerieSeriePreferiti.get(i).getNumeroTelefonico(), controller.librerieSeriePreferiti.get(i).getSitoWeb()});   //aggiunge una nuova riga nella tabella
                        } else{
                            model.addRow(new Object[]{controller.serieTitoloPreferiti.get(i), controller.possessosPreferiti.get(i).getQuantita(), controller.possessosPreferiti.get(i).getFruizione(), controller.librerieSeriePreferiti.get(i).getNome(), controller.librerieSeriePreferiti.get(i).getIndirizzo(), controller.librerieSeriePreferiti.get(i).getNumeroTelefonico(), controller.librerieSeriePreferiti.get(i).getSitoWeb()});  //aggiunge una nuova riga nella tabella
                        }
    ...
    private void search(Controller controller){    //esegue una ricerca nella tabella
        if (searchBarField.getText().isBlank()) {  //controlla se è stato inserito un testo nel JTextField 'searchBarField'
            ...
            if (controller.libriTitoloPreferiti != null && controller.possessolPreferiti != null && controller.librerieLibriPreferiti != null) {    //controlla se 'controller.libriTitoloPreferiti', 'controller.possessolPreferiti' e 'controller.librerieLibriPreferiti' non sono a null
                for (int i = 0; i < controller.libriTitoloPreferiti.size(); i++) {  //scorre la lista dei libri preferiti dell'utente
                    String quantita = String.valueOf(controller.possessolPreferiti.get(i).getQuantita());    //quantità disponibile dell'i-esimo libro

                    if(controller.libriTitoloPreferiti.get(i).toLowerCase().contains(searchBarField.getText().toLowerCase()) || quantita.toLowerCase().contains(searchBarField.getText().toLowerCase()) || controller.possessolPreferiti.get(i).getFruizione().toLowerCase().contains(searchBarField.getText().toLowerCase()) || controller.librerieLibriPreferiti.get(i).getNome().toLowerCase().contains(searchBarField.getText().toLowerCase()) || (controller.librerieLibriPreferiti.get(i).getIndirizzo() != null && controller.librerieLibriPreferiti.get(i).getIndirizzo().toLowerCase().contains(searchBarField.getText().toLowerCase())) || controller.librerieLibriPreferiti.get(i).getNumeroTelefonico().toLowerCase().contains(searchBarField.getText().toLowerCase()) || (controller.librerieLibriPreferiti.get(i).getSitoWeb() != null && controller.librerieLibriPreferiti.get(i).getSitoWeb().toLowerCase().contains(searchBarField.getText().toLowerCase()))){    //controlla se una delle celle dell'i-esima riga della tabella contiene il contenuto della barra di ricerca
                        if(controller.possessolPreferiti.get(i).getFruizione().equals("Digitale") || controller.possessolPreferiti.get(i).getFruizione().equals("AudioLibro")) {  //controlla se l'i-esimo libro è disponibile in modalità digitale o audiolibro
                            model.addRow(new Object[]{controller.libriTitoloPreferiti.get(i), "∞", controller.possessolPreferiti.get(i).getFruizione(), controller.librerieLibriPreferiti.get(i).getNome(), controller.librerieLibriPreferiti.get(i).getIndirizzo(), controller.librerieLibriPreferiti.get(i).getNumeroTelefonico(), controller.librerieLibriPreferiti.get(i).getSitoWeb()}); //aggiunge una nuova riga nella tabella
                        } else if(controller.possessolPreferiti.get(i).getFruizione().equals("Cartaceo") && controller.possessolPreferiti.get(i).getQuantita() == 0) {    //controlla se l'i-esimo libro non è disponibile
                            model.addRow(new Object[]{controller.libriTitoloPreferiti.get(i), "Non Diponibile", controller.possessolPreferiti.get(i).getFruizione(), controller.librerieLibriPreferiti.get(i).getNome(), controller.librerieLibriPreferiti.get(i).getIndirizzo(), controller.librerieLibriPreferiti.get(i).getNumeroTelefonico(), controller.librerieLibriPreferiti.get(i).getSitoWeb()});   //aggiunge una nuova riga nella tabella
            ...
            if (controller.serieTitoloPreferiti != null && controller.possessosPreferiti != null && controller.librerieSeriePreferiti != null) {    //controlla se 'controller.serieTitoloPreferiti', 'controller.possessosPreferiti' e 'controller.librerieSeriePreferiti' non sono a null
                for (int i = 0; i < controller.serieTitoloPreferiti.size(); i++) {  //scorre la lista delle serie preferite dell'utente
                    String quantita = String.valueOf(controller.possessosPreferiti.get(i).getQuantita());    //quantità disponibile dell'i-esima serie

                    if (controller.serieTitoloPreferiti.get(i).toLowerCase().contains(searchBarField.getText().toLowerCase()) || quantita.toLowerCase().contains(searchBarField.getText().toLowerCase()) || controller.possessosPreferiti.get(i).getFruizione().toLowerCase().contains(searchBarField.getText().toLowerCase()) || controller.librerieSeriePreferiti.get(i).getNome().toLowerCase().contains(searchBarField.getText().toLowerCase()) || controller.librerieSeriePreferiti.get(i).getIndirizzo().toLowerCase().contains(searchBarField.getText().toLowerCase()) || controller.librerieSeriePreferiti.get(i).getNumeroTelefonico().toLowerCase().contains(searchBarField.getText().toLowerCase()) || (controller.librerieSeriePreferiti.get(i).getSitoWeb() != null && controller.librerieSeriePreferiti.get(i).getSitoWeb().toLowerCase().contains(searchBarField.getText().toLowerCase()))){   //controlla se una delle celle dell'i-esima riga della tabella contiene il contenuto della barra di ricerca
                        if (controller.possessosPreferiti.get(i).getFruizione().equals("Digitale") || controller.possessosPreferiti.get(i).getFruizione().equals("AudioLibro")){  //controlla se l'i-esima serie è disponibile in modalità digitale o audiolibro
                            model.addRow(new Object[]{controller.serieTitoloPreferiti.get(i), "∞", controller.possessosPreferiti.get(i).getFruizione(), controller.librerieSeriePreferiti.get(i).getNome(), controller.librerieSeriePreferiti.get(i).getIndirizzo(), controller.librerieSeriePreferiti.get(i).getNumeroTelefonico(), controller.librerieSeriePreferiti.get(i).getSitoWeb()});    //aggiunge una nuova riga nella tabella
                        } else if (controller.possessosPreferiti.get(i).getFruizione().equals("Cartaceo") && controller.possessosPreferiti.get(i).getQuantita() == 0) {   //controlla se l'i-esimo fascicolo non è disponibile
                            model.addRow(new Object[]{controller.serieTitoloPreferiti.get(i), "Non Diponibile", controller.possessosPreferiti.get(i).getFruizione(), controller.librerieSeriePreferiti.get(i).getNome(), controller.librerieSeriePreferiti.get(i).getIndirizzo(), controller.librerieSeriePreferiti.get(i).getNumeroTelefonico(), controller.librerieSeriePreferiti.get(i).getSitoWeb()});   //aggiunge una nuova riga nella tabella
            ...
            if (controller.fascicoliTitoloPreferiti != null && controller.possessofPreferiti != null && controller.librerieFascicoliPreferiti != null) {
                for (int i = 0; i < controller.fascicoliTitoloPreferiti.size(); i++) {  //scorre la lista dei fascicoli preferiti dallutente
                    String quantita = String.valueOf(controller.possessofPreferiti.get(i).getQuantita());    //quantità disponibile dell'i-esimo fascicolo

                    if (controller.fascicoliTitoloPreferiti.get(i).toLowerCase().contains(searchBarField.getText().toLowerCase()) || quantita.toLowerCase().contains(searchBarField.getText().toLowerCase()) || controller.possessofPreferiti.get(i).getFruizione().toLowerCase().contains(searchBarField.getText().toLowerCase()) || controller.librerieFascicoliPreferiti.get(i).getNome().toLowerCase().contains(searchBarField.getText().toLowerCase()) || controller.librerieFascicoliPreferiti.get(i).getIndirizzo().toLowerCase().contains(searchBarField.getText().toLowerCase()) || controller.librerieFascicoliPreferiti.get(i).getNumeroTelefonico().toLowerCase().contains(searchBarField.getText().toLowerCase()) || (controller.librerieFascicoliPreferiti.get(i).getSitoWeb() != null && controller.librerieFascicoliPreferiti.get(i).getSitoWeb().toLowerCase().contains(searchBarField.getText().toLowerCase()))) {  //controlla se una delle celle dell'i-esima riga della tabella contiene il contenuto della barra di ricerca
                        if (controller.possessofPreferiti.get(i).getFruizione().equals("Digitale") || controller.possessofPreferiti.get(i).getFruizione().equals("AudioLibro")){  //controlla se l'i-esimo fascicolo è disponibile in modalità digitale o audiolibro
                            model.addRow(new Object[]{controller.fascicoliTitoloPreferiti.get(i), "∞", controller.possessofPreferiti.get(i).getFruizione(), controller.librerieFascicoliPreferiti.get(i).getNome(), controller.librerieFascicoliPreferiti.get(i).getIndirizzo(), controller.librerieFascicoliPreferiti.get(i).getNumeroTelefonico(), controller.librerieFascicoliPreferiti.get(i).getSitoWeb()});    //aggiunge una nuova riga nella tabella
                        } else if (controller.possessofPreferiti.get(i).getFruizione().equals("Cartaceo") && controller.possessofPreferiti.get(i).getQuantita() == 0){    //controlla se l'i-esimo fascicolo non è disponibile
                            model.addRow(new Object[]{controller.fascicoliTitoloPreferiti.get(i), "Non Diponibile", controller.possessofPreferiti.get(i).getFruizione(), controller.librerieFascicoliPreferiti.get(i).getNome(), controller.librerieFascicoliPreferiti.get(i).getIndirizzo(), controller.librerieFascicoliPreferiti.get(i).getNumeroTelefonico(), controller.librerieFascicoliPreferiti.get(i).getSitoWeb()});   //aggiunge una nuova riga nella tabella

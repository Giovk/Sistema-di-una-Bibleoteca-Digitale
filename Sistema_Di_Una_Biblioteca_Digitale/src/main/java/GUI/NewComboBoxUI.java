...
public class NewComboBoxUI extends BasicComboBoxUI {
    ...
    public void installUI(JComponent jc) {
        ...
        txt.addFocusListener(new FocusAdapter() {
            ...
            public void focusGained(FocusEvent fe) {
                border.setColor(new Color(207, 158, 41));
            }

            @Override
            public void focusLost(FocusEvent fe) {
                border.setColor(new Color(255, 211, 105));
            }
        });
        comboBox.addPopupMenuListener(new PopupMenuListener() {
            @Override
            public void popupMenuWillBecomeVisible(PopupMenuEvent pme) {
                arrowButton.setBackground(new Color(34, 40, 49));
            }
        ...
        txt.setSelectionColor(new Color(207, 158, 41));
        txt.setBorder(new EmptyBorder(0, 4, 0, 4));
        comboBox.setBackground(new Color(0xFFD369));
        ...
        return new ListCellRenderer() {
            ...
            public Component getListCellRendererComponent(JList jlist, Object e, int i, boolean bln, boolean bln1) {
                ...
                if (bln) {
                    ...
                    label.setBackground(new Color(207, 158, 41));
    ...
    private class ComboSuggestionPopup extends BasicComboPopup {
        ...
        protected JScrollPane createScroller() {
            ...
            list.setBackground(new Color(0xFFD369));
            newScrollBar sb = new newScrollBar();
            sb.setPreferredSize(new Dimension(12, 70));
            scroll.setVerticalScrollBar(sb);
            newScrollBar sbH = new newScrollBar();

...
/**
 * La classe SeriePage implemeta l'interfaccia grafica della pagina che mostra tutte le informazioni della serie selezionata e permette di
 * recensirla e metterla nei preferiti.
 */
public class SeriePage {
    ...
    /**
     * Cambia le icone delle stelle mostrate in base alla valutazione fatta dall'utente alla serie selezionata.
     *
    ...
    /**
     * Mostra i commenti fatti alla serie selezionata.
     *
     * @param controller il controller
    ...
    /**
     * Aggiunge in 'commenti' un commento fatto dall'utente che ha effettuato l'accesso alla serie selezionata.
     *

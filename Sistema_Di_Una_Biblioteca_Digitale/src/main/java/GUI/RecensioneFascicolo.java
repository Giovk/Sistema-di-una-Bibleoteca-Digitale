...
public class RecensioneFascicolo extends JDialog {
    public JFrame frame;
    ...
    public RecensioneFascicolo(JFrame frameC, Controller controller, JLabel valutazioneC, JLabel s1, JLabel s2, JLabel s3, JLabel s4, JLabel s5, JPanel commenti) {
    ...
    public void showComment(Controller controller, JPanel commenti){    //mostra i commenti del libro selezionato
        controller.selezionaFascicolo(numero, titolo);
